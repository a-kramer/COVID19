...
int covid19_jacp(int N_, realtype t,
    ...
    DENSE_ELEM(jacp_, 1, 6) = (1.0/8.0)*pow(Pi,-(1.0/2.0))/Population*exp(-3.1250000000000000e-02*lpow( g+t,2))*pow(2.0,(1.0/2.0))*( -6.2500000000000000e-02*g+-6.2500000000000000e-02*t);
...
int covid19_sens(int Ns_, realtype t, N_Vector y_, N_Vector ydot_,
	...
	switch (iS_) {
        ...
        case 5:
	        ...
	        break;
        case 6:
	            NV_Ith_S(ySdot_,1) += (1.0/8.0)*pow(Pi,-(1.0/2.0))/Population*exp(-3.1250000000000000e-02*lpow( g+t,2))*pow(2.0,(1.0/2.0))*( -6.2500000000000000e-02*g+-6.2500000000000000e-02*t);
	        break;
        case 7:

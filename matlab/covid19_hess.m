...
function hess_ = covid19_hess(t,x_,p_)
    ...
    hess_(1,1,2) = -l*distancing_on*r0_dist+l*r0*(-1+distancing_on);
    hess_(1,2,1) = hess_(1,1,2);
    hess_(1,2,2) = -2*l*distancing_on*r0_dist+2*l*r0*(-1+distancing_on);
    hess_(1,2,3) = -l*distancing_on*r0_dist+l*r0*(-1+distancing_on);
    hess_(1,3,2) = hess_(1,2,3);
    hess_(1,2,4) = -l*distancing_on*r0_dist+l*r0*(-1+distancing_on);
    hess_(1,4,2) = hess_(1,2,4);
    hess_(1,2,5) = -l*distancing_on*r0_dist+l*r0*(-1+distancing_on);

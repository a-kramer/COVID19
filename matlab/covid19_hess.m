...
function hess_ = covid19_hess(t,x_,p_)
    ...
    hess_(1,1,2) = -distancing_on*r0_dist*l+r0*(-1+distancing_on)*l;
    hess_(1,2,1) = hess_(1,1,2);
    hess_(1,2,2) = -2*distancing_on*r0_dist*l+2*r0*(-1+distancing_on)*l;
    hess_(1,2,3) = -distancing_on*r0_dist*l+r0*(-1+distancing_on)*l;
    hess_(1,3,2) = hess_(1,2,3);
    hess_(1,2,4) = -distancing_on*r0_dist*l+r0*(-1+distancing_on)*l;
    hess_(1,4,2) = hess_(1,2,4);
    hess_(1,2,5) = -distancing_on*r0_dist*l+r0*(-1+distancing_on)*l;
